...
//// modifiers below
    ...
    function setup(uint expectedEscrowAmount,
        ...
        swaps[escrowHashLock].timeout = startTime + 11 * DELTA;

        //set up escrow mapping
        escrows[escrowHashLock].current = 0;
        escrows[escrowHashLock].expected = expectedEscrowAmount;
        escrows[escrowHashLock].deadline = startTime + 8 * DELTA;
        escrows[escrowHashLock].timeout = startTime + 11 * DELTA;
        ...
        escrowPremiums[escrowHashLock].deadline = startTime + 2 * DELTA;
        escrowPremiums[escrowHashLock].timeout = startTime + 8 * DELTA;
